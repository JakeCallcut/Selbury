    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="space-y-8 text-muted leading-relaxed">
        <section>
          ...
          <p>
            Selbury is committed to protecting your privacy. This policy explains what 
        ...
        <section>
          ...
          <p>
            We may use basic analytics to understand how our website is used. This data 
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-3 space-y-1">
            <li>Deliver products you have purchased</li>
        ...
        <section>
          ...
          <p>
            We use minimal cookies to remember your theme preference (light/dark mode). 
        ...
        <section>
          ...
          <p>
            Under UK data protection law (UK GDPR), you have rights including:
          </p>
          <ul className="list-disc pl-6 mt-3 space-y-1">
        ...
        <section>
          ...
          <p>
            We implement appropriate security measures to protect any personal information 
            we hold. However, no method of transmission over the internet is 100% secure.
          </p>
        </section>
